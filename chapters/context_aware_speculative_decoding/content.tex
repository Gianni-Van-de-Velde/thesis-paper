...
\begin{figure}
  ...
  \begin{tabular}{@{}l@{}@{}l@{}@{}l@{}}
    \includegraphics[width=.33\linewidth]{fig/prob_casd_accept.png} & \includegraphics[width=.33\linewidth]{fig/prob_casd_eagle_overlap.png} & \includegraphics[width=.33\linewidth]{fig/prob_casd_non_eagle_accept.png} \\[0.5cm]
