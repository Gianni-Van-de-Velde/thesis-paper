...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=\linewidth]{fig/zenya.png}}
...
\begin{figure}[ht]
    \centerline{\fbox{\includegraphics[width=0.5\linewidth]{fig/pdf_clutter.png}}}
...
\begin{figure}[h]
    \centerline{\fbox{\includegraphics[width=0.8\linewidth]{fig/out_of_context_zenya_doc.png}}}
...
\begin{itemize}
    ...
    \item Reduced server requirements, which allows running the application on a server with a cheap (or even no) GPU.
\end{itemize}
