...
\begin{figure}[H]
    ...
    \caption{The distribution of all conversations, indicating whether the answer was found or not. And this for both the RAG system and the old system, Zenya.}
    \label{fig:found_rate}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=0.7\linewidth]{fig/RAG_nr_correct_in_conversation.png}}
    \caption{Distribution of the number of unique correct documents found in a whole conversation.}
    \label{fig:liked_docs_per_convo}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=0.7\linewidth]{fig/RAG_nr_top_3.png}}
    \caption{Distribution of the number of unique correct documents found per individual message.}
...
\begin{figure}[H]
    ...
    \caption{Distribution of the rank of the first correct document.}
...
\begin{figure}[H]
    ...
    \caption{Cumulative distribution of the rank of the first correct document.}
...
As final recommendations for the UZGent we suggest the following. \textbf{Drop the generative model} and just make the retriever very strong. We see only advantages in this:
\begin{itemize}
